...
{    
    ...
    $flag = 0;
    $q1 = "INSERT INTO `rooms` (`name`, `capacity`, `description`) VALUES (?,?,?)";
    $values = [$frm_data['name'],$frm_data['capacity'],$frm_data['desc']];
...
if(isset($_POST['edit_room']))
{
    ...
    $frm_data = filteration($_POST);
    $flag = 0;
    $q1 = "UPDATE `rooms` SET `name`= ? ,`capacity`= ? ,`description`= ? WHERE `id` = ?";
    $values = [$frm_data['name'],$frm_data['capacity'],$frm_data['desc'],$frm_data['room_id']];
    ...
    $del_features = deletei("DELETE FROM `room_features` WHERE `room_id` = ?",[$frm_data['room_id']],'i');
...
if(isset($_POST['remove_room']))
{
    ...
    $res2 = deletei("DELETE FROM `room_image` WHERE `room_id` = ?",[$frm_data['room_id']],'i');
    $res3 = deletei("DELETE FROM `room_features` WHERE `room_id` = ?",[$frm_data['room_id']],'i');
